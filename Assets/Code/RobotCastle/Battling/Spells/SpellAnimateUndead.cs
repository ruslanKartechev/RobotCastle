...
{
    public class SpellAnimateUndead : Spell, IFullManaListener, IHeroProcess
    {
        public SpellAnimateUndead(SpellConfigAnimateUndead config, HeroComponents components)
        {
        ...
        private SpellConfigAnimateUndead _config;
