...
{
    public class MergeUnitsWithWeaponsOperation : IItemsChoiceListener
    {
        ...
        public MergeUnitsWithWeaponsOperation(IItemView unitMoving, IItemView unitStanding, 
        ...
        private void SetPositions()
        {
            ...
            // ServiceLocator.Get<IPlayerHeroesContainer>().Remove(_unitMoving);
        }
